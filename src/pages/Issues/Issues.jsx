  ...
  return (
    <div className="issues-main">
      ...
      <div className="issues-other">
        <p>
        {t("veganism.veganism_more")}
        </p>
        <p>
          {t("veganism.veganism_more_link")} 
          <a href={t("routes.resources")}> {t("veganism.veganism_more_link_click")}</a>.
        </p>
      </div>
